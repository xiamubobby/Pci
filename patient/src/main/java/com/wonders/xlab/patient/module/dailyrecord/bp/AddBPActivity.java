...
public class AddBPActivity extends AppbarActivity implements IAddRecordPresenter {
    ...
    public int getContentLayout() {
        return R.layout.blood_pressure_add_activity;
    }
    ...
    public void save() {
        ...
        mAddRecordPresenter.saveBPSingle(AIManager.getInstance(this).getUserId(), date, Integer.valueOf(heartRate), Integer.valueOf(systolicPressure), Integer.valueOf(diastolicPressure));
    }
