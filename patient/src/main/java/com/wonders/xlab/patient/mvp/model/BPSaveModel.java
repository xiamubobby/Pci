...
public class BPSaveModel extends PatientBaseModel<SimpleEntity> {
    private IBPSaveModel mIBPSaveModel;
    private AddRecordAPI mAddRecordAPI;

    public BPSaveModel(IBPSaveModel IBPSaveModel) {
        mIBPSaveModel = IBPSaveModel;
    ...
    protected void onSuccess(SimpleEntity response) {
        mIBPSaveModel.onSaveBPSuccess("保存血压成功！");
    }

    @Override
    protected void onFailed(Throwable e) {
        mIBPSaveModel.onReceiveFailed("保存血压失败，请重试！");
    }
}
