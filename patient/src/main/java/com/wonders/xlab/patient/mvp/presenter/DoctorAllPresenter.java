 ...
 */
public class DoctorAllPresenter extends BasePresenter {

    private IDoctorAllPresenter mIDoctorAllPresenter;

    public DoctorAllPresenter(IDoctorAllPresenter iDoctorAllPresenter) {
        mIDoctorAllPresenter = iDoctorAllPresenter;
    }
    ...
    public void getAllDoctor() {
        ...
        mIDoctorAllPresenter.showAllDoctorList(doctorItemBeanArrayList);
    }
}
