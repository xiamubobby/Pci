...
//    public final static String BASE_URL = "http://xlab-tech.com:45675/pci-doctor/v1/";
    public static String BASE_URL = "http://172.16.77.93:8080/v1/";
//    public static String BASE_URL = "http://192.168.1.101:8080/v1/";
    public static final String ERROR_MESSAGE = "获取数据失败，请重试！";

    public static void setBaseUrl(Context context) {
        BASE_URL = SPManager.get(context).getString(PREF_KEY_BASE_URL,"http://172.16.77.93:8080/v1/");
    }
}
